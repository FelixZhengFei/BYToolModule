...
public class FFAttributeString {
    ...
    public func addAction(_ action:(()->())?) -> FFAttributeString{
        self.action = action
        return self
    }
...
public class FFAttrTextView: UITextView {
    
    public var selectedBackgroundColor: UIColor?
    private var storageTexts: [FFAttributeString] = []
    private var selectedAttribute: FFAttributeString?
    private var originalAttributeText: NSAttributedString?
    
    public func removeAllAttribute()->FFAttrTextView{
        text = ""
        return self
    }
    
    @discardableResult
    public func appendAttributedText(_ attribute: FFAttributeString) -> FFAttrTextView{
